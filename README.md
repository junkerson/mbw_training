...
3. Click the "Next" button to go to the next bird. If Autoplay option is checked (it is by default), the next audio clip will play and you can again make your guess and get feedback. Otherwise, click the play button to hear the audio and proceed.
